...
def config(config_db):
  section = 'postgresql'
  config_file_path = 'config1/' + config_db
  if(len(config_file_path) > 0 and len(section) > 0):
    ...
    if(config_parser.has_section(section)):
      ...
      config_params = config_parser.items(section)      # Convert the list object to a python dictionary object
      ...
      for config_param in config_params:
        ...
        db_conn_dict[key] = value      # Get connection object use above dictionary object
      return db_conn_dict  